...
MovieDetailsType _$MovieDetailsTypeFromJson(Map<String, dynamic> json) =>
    MovieDetailsType(
      ...
      videos: MovieDetailsVideoT.fromJson(
        json['videos'] as Map<String, dynamic>,
      ),
    );

Map<String, dynamic> _$MovieDetailsTypeToJson(
  MovieDetailsType instance,
) => <String, dynamic>{
