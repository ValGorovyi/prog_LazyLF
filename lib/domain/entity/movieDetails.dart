...
import 'package:prog_lazy_f/domain/entity/movieDetailsVideoT.dart';
...
class MovieDetailsType {
  ...
  final MovieDetailsVideoT videos;
  MovieDetailsType({
    required this.adult,
  ...
  Map<String, dynamic> toJson() => _$MovieDetailsTypeToJson(this);
}
